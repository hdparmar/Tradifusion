...
# Python Script to Produce Spectrograms of Multuple Audio Files
...
# Adding the argument to generate spectrogram from multiple audio files
parser.add_argument("-r", "--root", type=str, help="Root Directory of music dataset")
...
for filename in os.listdir(root_dir):
    ...
    # Skip directories
    if not os.path.isfile(full_path) or not filename.lower().endswith('.mp3'):
        continue
    ...
    # Generate a list of spectrogram images from the audio file
    ...
    input_filename_only = os.path.splitext(filename)[0]
